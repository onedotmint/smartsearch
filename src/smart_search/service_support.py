...
PROVIDER_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "brave": {
        "capability": "web_search",
        "config_attrs": ("brave_api_key",),
        "enabled_attr": "brave_enabled",
        "enabled_key": "BRAVE_ENABLED",
        "fallback_order": {"web_search": 4},
        "strengths": ["fresh web", "general web discovery"],
        "exclusions": ["docs semantic replacement", "URL fetch"],
        "fallback_group": "web_search",
        "minimum_profile_role": "",
        "quality_filters": ["URL required"],
        "route_reasons": ["fresh/general web discovery"],
    },
    "anysearch": {
